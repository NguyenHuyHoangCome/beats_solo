...
<div class="layout-content" id="crudApp">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="font-weight-bold py-3 mb-0">Hóa đơn đã hoàn thành, khách hàng đã nhận</h4>
        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                <li class="breadcrumb-item active" >Hóa đơn đã hoàn thành</li>
            </ol>
        </div>
        <div class="row mb-2">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br>
                        <label>Id nhân viên check: {{allData.id_user}}</label>
                        <br>
                        <label>Hoàn thành: {{allData.is_completed}}</label>
                        </div>
                        <div class="form-group">
                        ...
                        <br />
                        <div align="center">
                        <a :href="linkcom(allData.id_order)" class="btn btn-outline-success">Có lỗi xảy ra, Gửi lại cho khách hàng</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    data:{
        allData:'',
        myModel:false,
        link: "index.php?controller=order&action=NotDone&id=",
