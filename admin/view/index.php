        ...
        <div class="col-lg-7">
            <div class="card mb-4">
                <div class="card-header with-elements">
                    <h6 class="card-header-title mb-0">Chỉ tiêu tháng</h6>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <?php foreach($pro_dem as $pro) { ?>
                                    <div class="text-large"><?=$pro['numPro']?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <?php foreach($pro_thang as $pro) { ?>
                                    <div class="text-large"><?=$pro['tong']?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <div class="row no-gutters row-bordered row-border-light h-100">
                            <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center">
                                <div class="card-body media align-items-center text-dark">
                                    ...
                                    <?php foreach($order_money as $pro) { ?>
                                    <span class="media-body d-block ml-3"><span class="text-big mr-1 text-primary"><?php echo "$".$pro['money']?></span>
                                    <?php } ?>
                                        <br>
                    ...
                    <div class="d-flex col-md-6 col-lg-3 align-items-center">
                        <div class="card-body">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col">
                                    <h6 class="mb-0 text-muted">Total <span class="text-primary">Products Sales</span></h6>
                                    <?php foreach($pro_tong as $pro) { ?>
                                        <h4 class="mt-3 mb-0"><?=$pro['tongsl']?></h4>
                                    <?php } ?>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <?php foreach($order_tong as $pro) { ?>
                                        <h4 class="mt-3 mb-0"><?=$pro["tong_order"]?><i class="ion ion-md-arrow-round-up ml-3 text-success"></i></h4>
                                    <?php } ?>
                                </div>
                            </div>
